...
<section class="content">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">
        <h3 class="card-title">Data Surat Keterangan Tidak Mampu Rumah Sakit</h3>
        <div class="card-tools">
          <a href="{{route('sktmrs.create')}}" class="btn btn-block btn-secondary btn-sm">Tambah Data</a>
      </div>
    </div>
    <div class="card-body">
      <div class="row">
    ...
    <div class="card-body">
      <div class="table-responsive">
        <table id="data_sktmrs" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
            <thead>
                <tr>
                    <th> No </th>
                    <th> No Surat</th>
            ...
            <tr>
              <th scope="row">{{$no}}
                ...
                <td>
                  ...
                  <a class="btn btn-warning btn-sm" href="{{URL::to('suket-tidakmampu-rumahsakit/show/'.$post->id_persuratan)}}"><i class="fas fa-info-circle"></i> Detail </a>
                </td>
              </tr>
            </form>
              @endforeach
