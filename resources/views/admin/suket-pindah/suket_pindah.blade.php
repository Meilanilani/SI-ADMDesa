  ...
  <div class="card">
    ...
    <div class="card-body">
      <div class="table-responsive">
        <table id="data_pindah" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
            <thead>
                <tr>
                    <th> No </th>
                    <th> No Surat</th>
            ...
            <tr>
              <th scope="row">{{$no}}
                ...
                <td>{{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $post->created_at)->isoFormat('D-MM-Y')}}</td>
                ...
                <td>
                  ...
                  <a class="btn btn-warning btn-sm" href="{{URL::to('suket-pindah/show/'.$post->id_persuratan)}}"><i class="nav-icon fas fa-trash"></i> Detail</a>
