...
<section class="content">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">
        <h3 class="card-title">Data Surat Keterangan Pengantar Nikah</h3>
        <div class="card-tools">
          <a href="{{route('pnikah.create')}}" class="btn btn-block btn-secondary btn-sm">Tambah Data</a>
      </div>
    </div>
    <div class="card-body">
      <div class="row">
    ...
    <div class="card-body">
      <div class="table-responsive">
        <table id="data_na" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
            <thead>
                <tr>
                    <th> No </th>
                    <th> No Surat</th>
