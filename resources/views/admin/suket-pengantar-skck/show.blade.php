                        ...
                        <table class="table no-border">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><a href="{{URL::to($skck->foto_pengantar)}}" target="_blank">Foto Pengantar
                                            RT/RW <br></a>
                                        <a href="{{URL::to($skck->foto_kk)}}" target="_blank">Foto Kartu Keluarga
                                            <br></a>
                                        <a href="{{URL::to($skck->foto_ktp)}}" target="_blank">Foto KTP 
                                            <br></a>
