            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        @endphp
                        @php
                        if(isset($notification->data['variable'])){
                        if($notification->data['variable'] == 'SKTM Sekolah' ){
                        $surat = route('sktmsekolah.index');
                        }
                        if($notification->data['variable']=='SKTM RS') {
                        ...
                        if($notification->data['variable']=='Surat Pengantar Nikah') {
                        $surat = route('pnikah.index');
                        }
                        if($notification->data['variable']=='Surat Pengantar SKCK') {
                        $surat = route('skck.index');
                        }
                        if($notification->data['variable']=='Surat KTP Sementara') {
                        $surat = route('ktp.index');
                        }
                        if($notification->data['variable']=='Surat Keterangan Usaha') {
                        $surat = route('usaha.index');
                        }
                        if($notification->data['variable']=='Surat Keterangan Pindah') {
                        $surat = route('pindah.index');
                        }
                        if($notification->data['variable']=='Surat Domisili') {
                        $surat = route('domisili.index');
                        }
                        if($notification->data['variable']=='Surat Pengantar KK') {
                        $surat = route('kk.index');
                        }}
                        @endphp
