...
<section class="content">
    <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">Tambah Data Surat Keterangan Pindah</h3>
                      ...
                      <div class="row">
                        ...
                        <input type="text" name="no_surat" class="form-control" placeholder="No Surat">
                            ...
                            <div class="col-md-8">
                              ...
                              <textarea name="alasan_pindah" class="form-control" rows="3"></textarea>
                            </div>
                            <div class="col-md-2">
                              <label for="inputName">Jumlah Pengikut</label>
                              <input type="number" name="jumlah_pengikut" class="form-control">
                            </div>
                            <div class="col-md-6">
