                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      @endif              
            <form method="POST" action="{{ route('datawarga.update', $warga) }}">
              @csrf
              @method('PATCH')
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-3">
                    ...
                    <select name="jenis_kelamin" value="{{ $warga->jenis_kelamin }}" id="warga-jenis_kelamin" class="form-control">
                  ...
                  <div class="col-md-6">
                    ...
                    <select name="agama" value="{{ $warga->agama }}" id="warga-agama" class="form-control">
                      <option>Islam</option>
                  ...
                  <div class="col-md-6">
                    ...
                    <select name="pendidikan" value="{{ $warga->pendidikan }}" id="warga-pendidikan" class="form-control">
                  ...
                  <div class="col-md-6">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <select name="status_perkawinan" value="{{ $warga->status_perkawinan }}" id="warga-status_perkawinan" class="form-control" class="form-control">
