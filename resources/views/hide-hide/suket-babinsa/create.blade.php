...
<section class="content">
    <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">Tambah Data Surat Keterangan Babinsa/h3>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    @endif
                    <form action="{{ route('babinsa.store')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                              ...
                              <input type="text"  name="nama_babinsa" class="form-control">
                            </div>
                              <div class="col-md-6">
                                <label for="inputName">Pangkat Babinsa</label>
                                <input type="text"  name="pangkat_babinsa" class="form-control" >
                              </div>
                              <div class="col-md-6">
                                <label for="inputName">Jabatan Babinsa</label>
                                <input type="text"  name="jabatan_babinsa" class="form-control" >
                              </div>
                              <div class="col-md-2">
                                <label for="inputName">TB Calon</label>
                                <input type="text"  name="tb_calon" class="form-control">
                              </div>
                              <div class="col-md-2">
                                <label for="inputName">BB Calon</label>
                                <input type="text"  name="bb_calon" class="form-control" >
                              </div>
                            <div class="col-md-7">
