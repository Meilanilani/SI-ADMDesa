...
<section class="content">
    <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">Tambah Data Surat Keterangan Domisili Lembaga</h3>
                      ...
                      <div class="row">
                        ...
                        <input type="text" name="no_surat" class="form-control" placeholder="No Surat">
                            ...
                            <div class="col-md-6">
                              ...
                              <input type="text"  name="no_telp_lembaga" class="form-control">
                            </div>
                            <div class="col-md-8">
                              <label for="inputName">Alamat Lembaga</label>
                              <textarea name="alamat_lembaga" class="form-control" rows="4"></textarea>
                            </div>
                            <div class="col-md-6">
                              <label for="inputDescription">Bidang Lembaga</label>
                              <input type="text"  name="bidang_lembaga" class="form-control">
                            </div>
                            <div class="col-md-2">
                              <label for="inputDescription">Pegawai</label>
                              <input type="text"  name="jumlah_pegawai" class="form-control">
                            </div>
                            <div class="col-md-2">
