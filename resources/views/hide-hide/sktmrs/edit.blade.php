...
<section class="content">
  <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">Ubah Data Pengajuan SKTM Rumah Sakit</h3>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    @endif
                    <form action="{{ url('suket-sktmrs/update/'.$sktmrs->id_persuratan)}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="form-group">
                      <div class="row">
                        <div class="col-md-6">
                        <label for="inputName">No Surat</label>
                        <input type="text" name="no_surat" class="form-control" value="{{ $sktmrs->no_surat}}">
                        </div>
                            <div class="col-md-8">
                              <label for="inputName">Keterangan Keperluan Surat</label>
                              <input name="ket_keperluan_surat" class="form-control" style="height: 60px" value="{{ $sktmrs->ket_keperluan_surat}}">
                            </div>
                            <div class="col-md-8">
