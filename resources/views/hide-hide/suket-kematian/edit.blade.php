                        ...
                        <input type="text" name="no_surat" class="form-control" value="{{ $kematian->no_surat}}">
                          ...
                          <div class="col-md-5">
                            ...
                            <div class="col-md-6">
                              ...
                              <input type="date"  name="tgl_kematian" class="form-control" value="{{ $kematian->tgl_kematian}}">
                            </div>
                            <div class="col-md-5">
                              <label for="inputName">Tempat Kematian</label>
                              <input name="tempat_kematian" class="form-control" value="{{ $kematian->tempat_kematian}}">
                            </div>
                            <div class="col-md-6">
                              <label for="inputName">Penyebab Kematian</label>
                              <input name="penyebab_kematian" class="form-control" value="{{ $kematian->penyebab_kematian}}">
                            </div>
                            <div class="col-md-8">
