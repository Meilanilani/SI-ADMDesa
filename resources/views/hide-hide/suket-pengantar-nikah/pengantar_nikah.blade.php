...
<section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Data Pengajuan Surat Pengantar Nikah</h3>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-12">
          <a href="{{route('pnikah.create')}}" class="btn btn-success float-right">Tambah Data</a>
          </div>
        </div>
                ...
                <tr>
                  <th scope="row">{{$no}}
                    ...
                    <td><a href="{{URL::to($post->foto_pengantar)}}" target="_blank">Foto Pengantar RT/RW |</a>
                        ...
                        <a href="{{URL::to($post->foto_ijazah)}}" target="_blank">Foto Ijazah Terakhir</a>
                    </td>
