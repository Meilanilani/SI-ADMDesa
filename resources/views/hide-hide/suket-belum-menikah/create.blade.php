...
<section class="content">
    <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">Tambah Surat Keterangan Belum Menikah</h3>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    @endif
                    <form action="{{ route('blm_menikah.store')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="row">
                        ...
                        <input type="text" name="ket_keperluan_surat" class="form-control">
                        </div>
                        <div class="col-md-8">
