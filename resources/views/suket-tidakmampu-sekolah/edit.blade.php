...
<section class="content">
  <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">Tambah Data Pengajuan SKTM Rumah Sakit</h3>
                  ...
                  <div class="col-md-6">
                    ...
                    <form action="{{ url('suket-tidakmampu-sekolah/update/'.$sktmsekolah->id_persuratan)}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <input type="text" name="no_surat" class="form-control" value="{{ $sktmsekolah->no_surat}}">
                        </div>
                            <div class="col-md-8">
                              <label for="inputName">Keterangan Keperluan Surat</label>
                              <input name="ket_keperluan_surat" class="form-control" style="height: 60px" value="{{ $sktmsekolah->ket_keperluan_surat}}">
                            </div>
                            <div class="col-md-8">
